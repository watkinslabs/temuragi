...
class ReportCLI(BaseCLI):
    ...
    def create_template(self, name, display_name, template_uuid, **kwargs):
        ...
        try:
            ...
            self.output_success(f"Report template created: {template.name} ({template.uuid})")
            return 0
    ...
    def list_reports(self, category=None, connection=None, show_permissions=False):
        ...
        try:
            ...
            if show_permissions:
                headers = ['Slug', 'Name', 'Category', 'Connection', 'Template', 'Public', 'Permissions']
            else:
                headers = ['Slug', 'Name', 'Category', 'Connection', 'Template', 'Public', 'Last Run']
    ...
    def show_report(self, report_id):
        ...
        try:
            ...
            structure = self.service.get_report_structure(report.uuid)
    ...
    def create_report(self, slug, name, query_file, connection, **kwargs):
        ...
        try:
            ...
            self.output_success(f"Report created: {report.slug} ({report.uuid})")
    ...
    def delete_report(self, report_id, force=False):
        ...
        try:
            ...
            self.service.delete_report(report.uuid)
    ...
    def duplicate_report(self, source_id, new_name, new_slug=None):
        ...
        try:
            ...
            new_report, message = self.service.duplicate_report(
                source.uuid, new_name, new_slug
            )

            self.output_success(message)
            self.output_info(f"New report: {new_report.slug} ({new_report.uuid})")
    ...
    def test_report(self, report_id):
        ...
        try:
            ...
            # Test the query
            columns = self.service.test_report_query(report.uuid)
    ...
    def execute_report(self, report_id, output_file=None, params=None):
        ...
        try:
            ...
            # Execute report
            result = self.service.execute_report(report.uuid, request_data)
    ...
    def list_executions(self, report_id=None, limit=20):
        ...
        try:
            if report_id:
                ...
                executions = self.service.get_report_execution_history(report.uuid, limit)
    ...
    def assign_report(self, report_id, role_name, actions=None):
        ...
        try:
            ...
            success, message = self.service.assign_report_to_role(
                report.uuid, role.uuid, action_list
            )
    ...
    def export_report(self, report_id, output_file):
        ...
        try:
            ...
            definition = self.service.export_report_definition(report.uuid)
    ...
    def import_report(self, input_file, connection):
        ...
        try:
            ...
            report = self.service.import_report_definition(definition, conn.uuid)

            self.output_success(f"Report imported: {report.slug} ({report.uuid})")
